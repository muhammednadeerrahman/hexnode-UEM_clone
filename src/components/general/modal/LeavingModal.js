...
export default function LeavingModal({setModalActive}) {
  return (
    <div className="sm:bg-[url('./assets/images/modalImage.webp')] rounded-lg bg-cover overflow-hidden  bg-[white] sm:h-[50vh] max-sj:w-[280px]  sj:w-[320px] sm:w-[550px] md:w-[700px] lg:w-[800px] xl:w-[900px] w-full relative">
       
    <button onClick={() => setModalActive(false)} className='top-6 right-6 absolute flex'>
