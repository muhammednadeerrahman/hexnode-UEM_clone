...
export default function MessageContainer() {
    ...
    return (
        <div className={`fixed flex flex-col justify-between overflow-hidden bottom-24 z-50 right-7 max-sm:h-[65vh] sm:h-[75vh] si:w-[280px] sj:w-[300px] sk:w-[400px] rounded-[8px] bg-white message-container`}>
